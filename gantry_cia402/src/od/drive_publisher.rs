...
pub async fn publish_updates(mut pdo: Arc<Mutex<Pdo>>) {
...
pub async fn write_update(pdo: &mut Arc<Mutex<Pdo>>, update: Update) -> Result<(), DriveError> {
